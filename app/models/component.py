"""
Makerspace RAG - Component Model
Component inventory tracking with helper functions
"""
...
class Component(db.Model):
    ...
    kategori: Mapped[str] = mapped_column(String(100), nullable=True, default='Annet')
    ...
    def to_dict(self):
        return {
            ...
            'kategori': self.kategori or 'Annet',
...
def add_component(name: str, hylleplass: str, kategori: str = 'Annet',
                  forbruksvare: bool = False, restock: bool = False, antall: int = 0):
    """Add a new component - hylleplass auto-uppercased."""
    component = Component(
        name=name,
        hylleplass=hylleplass.upper(),
        kategori=kategori or 'Annet',
...
def get_all_kategorier():
    """Get list of all unique kategori values (for dropdowns)."""
    results = db.session.query(Component.kategori).distinct().order_by(Component.kategori).all()
